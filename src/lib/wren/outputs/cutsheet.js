...
function isPartGeometry(o) {
  ...
  const hasPosition =
    o.pos &&
    typeof o.pos.x == "number" &&
    typeof o.pos.y == "number" &&
    typeof o.pos.z == "number";
  const hasRotation =
    o.rot &&
    typeof o.rot.order == "string" &&
    typeof o.rot.x == "number" &&
    typeof o.rot.y == "number" &&
    typeof o.rot.z == "number";
...
function layoutPartsWithoutOverlap(parts, separation = 50) {
  ...
  for (var part of parts) {
    ...
    const movedPoints = part.geometry.pts.map(xy =>
      addPoints(xy, displacement)
    );
